...
public class HomePageObject extends BasePage{
	...
	public void inputToTextboxByNumber(String headerName, String rowIndex, String value) {
	...
	public void clickToIconByRowNumber(String rowIndex, String actionButton) {
		waitForElementClickable(driver, HomePageUI.ACTION_BUTTON_BY_ROW_INDEX, rowIndex, actionButton);
		clickToElement(driver, HomePageUI.ACTION_BUTTON_BY_ROW_INDEX, rowIndex, actionButton);
	}
